...
#define PACKAGE_VERSION "Tesseract Open Source OCR Engine v4.1.1 with Leptonica"
#define TESSERACT_VERSION_STR "Tesseract Open Source OCR Engine v4.1.1 with Leptonica"
