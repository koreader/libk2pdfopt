...
rem
gcc -Ofast -m32 -Wall k2view.c -o k2view.exe -static-libgcc -static-libstdc++ d:\mingw\x32\lib\crt_noglob.o -Ld:\will\custom\mingw -lk2pdfopt -lwillus -lgdi32 -luuid -lole32 -lcomdlg32
k2view out.bmp
